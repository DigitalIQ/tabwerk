# Chrome Web Store: Texte zum Einfügen

## Name
Tabwerk

## Kurzbeschreibung (höchstens 132 Zeichen)
DE: Viele Tabs, klar geordnet: Schnellsuche, Gruppen, Aufräumen, Verlauf mit Rückgängig und Wächter für Webseiten.
EN: Many tabs, clearly organized: quick search, groups, cleanup, undo history and page watchers.
...
Tabwerk hält Ordnung, wenn du dutzende Tabs offen hast.

Schnellsuche
Ein Tastenkürzel öffnet eine Suche über jeder Seite. Sie findet Tabs, Aktionen, Lesezeichen, Verlauf, Sitzungen, Notizen und gespeicherte Formulare. Tippfehler und Abkürzungen sind kein Problem.
...
Aufräumen
• Doppelte Tabs finden und pro Seite entscheiden, was zugeht
• Doppelte gar nicht erst öffnen, mit Ausnahme, wenn du es wirklich willst
• Alte und unwichtige Tabs zum Schließen vorschlagen
• Inaktive Tabs entladen, um Speicher zu sparen
• Tabs schlummern lassen und später automatisch wieder öffnen

Sichern
• Nach jeder Änderung eine Sicherung von Fenstern, Tabs und Gruppen
• Rückgängig für jede Tabwerk-Aktion, pro Fenster
• Benannte Sitzungen, Export als Datei und als Lesezeichen-Datei
...
Jede Funktion lässt sich einzeln ausschalten. Tabwerk hat keinen eigenen Server und sammelt keine Nutzungsdaten. Der Quellcode steht unter MIT-Lizenz auf GitHub.

## Beschreibung (English)

Tabwerk keeps order when you have dozens of tabs open.
...
Back up: every change is saved as a snapshot of your windows, tabs and groups. Undo any Tabwerk action per window, save named sessions and export everything.
...
- Datenschutzerklärung: https://github.com/DigitalIQ/tabwerk/blob/main/PRIVACY.md

## Bilder
- Symbol 128x128: icons/icon128.png
- Screenshots 1280x800: store/images/1-schnellsuche.png bis 5-waechter.png
- Kleines Werbebild 440x280: store/images/promo-440x280.png
